...
describe('Module src:', () => {
  ...
  describe('Directories:', () => {
    ...
    it('should validate because optional directory as first and as last', () => {
      ...
      const configObject2: Types.FileDirectoryArray = [
        {
          name: 'src',
          type: 'directory',
          isOptional: true,
      ...
      it(`should throw when a rule matches 2 dirs (dirA, dirB), the rule first
        ...
        assert.throws(
          ...
          (err: Error) =>
            err.message.includes(
              `${JSON.stringify((
                configObject[0] as Types.Directory).rules![2]
