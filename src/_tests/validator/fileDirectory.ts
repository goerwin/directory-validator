...
describe('Files/Directories:', () => {
  ...
  it.skip('should validate a simple tree with recursion', () => {
    const files = generateFilesAndDirsFromPaths([
      'src/index.js',
      'src/src/index.js',
  ...
  it.skip('should not throw because recursive rule is optional', () => {
  ...
  it.skip(`should throw in a simple tree with
  ...
  it.skip('should throw a simple tree with recursion because random file', () => {
    const files = generateFilesAndDirsFromPaths([
      'src/index.js',
      'src/src/index.js',
      'src/src/src/index.js',
